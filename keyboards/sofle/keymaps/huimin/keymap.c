...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,  TG(_LOWER), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                 KC_LCTRL, KC_LGUI, KC_LALT, KC_SPC, KC_ENT,      KC_ENT, KC_BSPC,  KC_SPC,  KC_DEL,  MO(_LOWER) \
),
[_LOWER] = LAYOUT( \
